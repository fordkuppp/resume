...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Novel Reader} (\href{https://github.com/fordkuppp/novel-reader}{\underline{source}}, \href{https://github.com/fordkuppp/novel-reader}{\underline{don't forget to add demo}}) $|$ \emph{Python, Flask, Jinja, MySQL}}{}
          \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: Flask, SqlAlchemy, Spring, JPA, BootStrap} \\
     \textbf{Tools}{: Git, Docker, Unix, AWS(EC2), Digital Ocean} \\
